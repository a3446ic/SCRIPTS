...
--COMPARAR TABLAS
SELECT 	RAMO,IDPRODUCT,NUM_POLIZA,IDMODALIDAD,IDSUBMODALIDAD,NUM_EXPEDIENTE,NUM_AVAL_HOST,NUM_ANUALIDAD,FECHA_EMISION,FECHA_EFECTO,FECHA_VENCIMIENTO,
	IDPAIS,PRIMA_PROVISIONAL_INT,PRIMA_PROVISIONAL_EXT,IDDIVISA_INT,IDDIVISA_EXT,IDDIVISA_COBERTURA,PRIMA_MIN_INT,PRIMA_MIN_EXT,COD_MEDIADOR,
	FECHA_INICIO,FECHA_FIN,P_ESPECIAL_EMISION,P_ESPECIAL_RENOVACION,NIF_TOMADOR,MEDIADOR_PRINCIPAL_CIC,ACTIVO,CREATEDATE,MODIF_DATE,MODIF_USER 
FROM EXT.CARTERA WHERE RAMO = 'CREDITO'
EXCEPT
SELECT 	RAMO,IDPRODUCT,NUM_POLIZA,IDMODALIDAD,IDSUBMODALIDAD,NUM_EXPEDIENTE,NUM_AVAL_HOST,NUM_ANUALIDAD,FECHA_EMISION,FECHA_EFECTO,FECHA_VENCIMIENTO,
	IDPAIS,PRIMA_PROVISIONAL_INT,PRIMA_PROVISIONAL_EXT,IDDIVISA_INT,IDDIVISA_EXT,IDDIVISA_COBERTURA,PRIMA_MIN_INT,PRIMA_MIN_EXT,COD_MEDIADOR,
	FECHA_INICIO,FECHA_FIN,P_ESPECIAL_EMISION,P_ESPECIAL_RENOVACION,NIF_TOMADOR,MEDIADOR_PRINCIPAL_CIC,ACTIVO,CREATEDATE,MODIF_DATE,MODIF_USER
